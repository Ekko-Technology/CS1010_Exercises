...
Link: https://www.github.com/nus-cs1010-2425-s1/ex08-Ekko-Technology/commit/a63ebea27cbd2c75851bfd706b7b6835a6227832
...
- `clang` and `clang-tidy` generate 1 (non-documentation-related) warnings for `digits.c`. Always fix your code so that it compiles cleanly without warnings.

<details>
<summary>Warnings from clang/clang-tidy</summary>

```
digits.c:129:6: warning: function 'finding_k' exceeds recommended size/complexity thresholds [readability-function-size]
```
</details>

#### Test Cases

- Your `digits` fails to pass 1 of the test cases.
<details><summary>Hidden test cases that cause your `digits` to fail include the following:</summary>
...
- You can find [other comments from your tutor (if any) here](https://www.github.com/nus-cs1010-2425-s1/ex08-Ekko-Technology/commit/a63ebea27cbd2c75851bfd706b7b6835a6227832).

## Summary
| Question | Achievement |
|----------|-------|
| [digits](#digits) | Need Improvement |
